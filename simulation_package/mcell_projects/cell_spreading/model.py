...
# init_vol = vol*100
#
# nbrs = get_n(instantiation.Organelle_1.vertex_list, instantiation.Organelle_1.wall_list)
# init_area = []
# for j in range(len(instantiation.Organelle_1.vertex_list)):
#     init_area.append(get_area(j, nbrs.get(j), model, instantiation.Organelle_1))
...
for i in range(ITERATIONS):
    ...
    #         move = membrane_moves.vector_move(k)
    #         # replace vector below with move, a vector itself
    #         model.add_vertex_move(instantiation.Cell, k, move)
    #
    ...
    if i % 10 == 0:
        for k in range(CELL_NUM_VERTICES):
            ...
            # TODO fix En since sometimes should be lower than Ec
